<div class="modal-body text-center">
    ...
    <div class="border rounded p-2 bg-light text-start">
        <p class="mb-1"><strong>Código:</strong> {{ $categoria->idcategoria }}</p>
        <p class="mb-1"><strong>Descripción:</strong> {{ $categoria->descripcion }}</p>
    </div>
    <form method="POST" action="{{ route('categorias.destroy', $categoria->idcategoria) }}" class="mt-2">
        @method('delete')
        @csrf
